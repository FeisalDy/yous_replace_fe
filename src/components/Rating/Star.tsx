...
const Star = ({
  ...
  className,
  ...props
}: StarProps & SVGProps<SVGSVGElement>) => {
  // Filter out any props that are not valid for the SVG element
  ...
  return (
    <span className={className}>
      <svg
        ...
        {...svgProps} // Spread only valid SVG props
      >
        <path
          fillRule='evenodd'
          clipRule='evenodd'
